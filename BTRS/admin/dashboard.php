...
<?php
  ...
  if($_SESSION['email']!=null)
  {
    ...
    $sold_tickets = $booked_seat->GetAllSoldTkt()->fetch_assoc();
    $pending_tickets = $booking_info->GetAllPendingTkt()->fetch_assoc();
    $cancel_tickets = $cancel_request->GetAllPendingrequest()->fetch_assoc();
    }
?>
...
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  ...
                  <a href="dashboard.php?page=update_admin_profile" class="btn btn-default btn-flat">Profile</a>
                  <?php } else { ?>
                  <a href="dashboard.php?page=update_admin_profile" class="btn btn-default btn-flat">Profile</a>
                  <?php } ?>
  ...
  <aside class="main-sidebar" >
    ...
    <section class="sidebar">
      ...
      <span class="pull-right-container"> <small class="label pull-right bg-green"> <?php echo $pending_tickets['total']; ?></small> </span></a>
         ...
         <li class="treeview">
          <a href="#"><i class="fa fa-bell-o"></i> <span>Cancel Requests</span>

      <span class="pull-right-container"> <small class="label pull-right bg-green"> <?php echo $cancel_tickets['total']; ?></small> </span></a>
      
          <ul class="treeview-menu">
            <li><a href="dashboard.php?page=manage_cancel_request"><i class="fa fa-circle-o"></i> Manage Requests</a></li>
      ...
      <span class="pull-right-container"> </small> </span></a>
      
          <ul class="treeview-menu">
            <li><a href="dashboard.php?page=add_report"><i class="fa fa-bar-chart"></i></i> Generate Report</a></li>
  ...
  <div class="content-wrapper" >
    <?php 
      switch (@$_GET['page']) {
        ...
        case "manage_cancel_request": {
          include("manage_cancel_request.php");
          break;
        ...
        case "view_request": {
         ...
         case "view_cancel_request": {
          include("view_cancel_request.php");
          break;  
        }
  ...
  <footer class="main-footer">
   <div style="text-align:center;">
    <strong >Copyright &copy;  <a href="#">Team Unique (Software Engineering)</a>.</strong> All rights
    reserved.
	</div>
  </footer>
