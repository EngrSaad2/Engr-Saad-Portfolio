...
class Trip_info
{
	...
	public function GetSearchBus($from_city,$to_city,$time){

		$sql = "SELECT * FROM tbl_trip_info INNER JOIN tbl_bus_info ON tbl_trip_info.bus_id = tbl_bus_info.bus_id WHERE  tbl_trip_info.from_city='$from_city' AND tbl_trip_info.to_city='$to_city' AND tbl_trip_info.departure_time >= '$time' ORDER by departure_time ASC";
