...
require("admin/db_connect_for_pdf/connection.php");
		...
		$sql = $conn->prepare("SELECT * FROM tbl_booking_info,tbl_passenger_info, tbl_trip_info, tbl_counter_info,tbl_bus_info WHERE tbl_booking_info.passenger_id = tbl_passenger_info.id AND tbl_booking_info.trip_id=tbl_trip_info.trip_id AND tbl_booking_info.counter_id=tbl_counter_info.counter_id AND tbl_booking_info.pnr_no='$pnr_no'");
		$sql->execute();		
...
<div class="bus-btm">
	...
	?>
          ...
          <div class="col-md-12">
			...
			<div class="panel-heading" style="background-color:blue; height: 60px;"><h4 style="font-size:30px;color:white; text-align: center;">Your Booking Details</h4></div>
				...
				<?php
				 ...
				 <p style="font-weight: bolder; color:#001a00"> You have 0 hours left.<you></you>So you cannot cancel this ticket. Read the policy! </p><br />
				 <?php } ?>
				...
				<input type="hidden" name="passenger_id" value="<?php echo $data['id']; ?>">	
